...
// grouped by pillar. Report grade labels (not %), full factor names (no truncation).
            ...
            {pillar.factors.map(f => {
              ...
              return (
                <div key={f.name} className="flex items-center gap-3">
                  ...
                  <span className="text-[12px] font-medium w-24 text-right shrink-0" style={{ color: c }}>{f.grade}</span>
                </div>
              );
            })}
          </div>
