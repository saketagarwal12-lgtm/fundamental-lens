...
const spandana: CompanyReport = {
  ...
  financials: {
    ...
    profitability: mk('Weak', 41, [
      { label: 'NIM', unit: '%', vals: [13.55, 14.25, 12.71] },
      { label: 'ROAA', unit: '%', vals: [4.40, -9.46, -6.44] },
      { label: 'ROAE', unit: '%', vals: [14.85, -32.98, -17.47] },
      { label: 'Cost-to-Income', unit: '%', vals: [65.85, 77.13, 133.42] },
      { label: 'Cost of Risk', unit: '%', vals: [2.68, 22.43, 6.38] },
      { label: 'PAT', unit: '₹ Cr', vals: [500.72, -1035.16, -94.97] },
    ], SPANDANA_PERIODS,
